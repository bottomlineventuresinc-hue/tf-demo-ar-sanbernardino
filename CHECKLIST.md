# Site customization checklist · AR Electrical (hs-037-ar)
Wave 8 · Copperline · claim/$297 + hosting/$99 bar required. Rebuilt 2026-09-25 (CEO change request).

Before preview send:
- [x] Business name everywhere (title, wordmark, footer, schema)
- [x] City / service area
- [x] Phone click-to-call is the main CTA (tel-only; no public email)
- [x] Address per packet (FARM-PACKETS-WAVE8.md)
...
Owner first name in human spots: Antonio
NAP/phone per packet: 4263 N Pershing Ave, San Bernardino CA 92407 · 951-533-5903
lang: en-US · geo: CA

## Change request 2026-09-25
CEO-approved change request (Waves 8 to 10). The prior build failed the rule audit
(stray control characters, invented promises on guarantee length, quote hold time,
callback speed and payment splits, sample-job dollar prices, domain/photo issues, missing sections on some).
Rebuilt on the Wave 11 generator (hs-007 full section layout, Wave 11 css/js, verified CC0 photos).
Lead-specific notes kept: arelectrical.com / ar-electrical.com are landers not owned by the lead; NOT linked or offered. Page covers electrical only (packet trade C10).
Prior folder backed up at ops/cr-2026-09-25/backup/hs-037-ar/.
