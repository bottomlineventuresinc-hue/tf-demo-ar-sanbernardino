/* Template Factory - AR Electrical live demo journey.
...
(function () {
  ...
  var LIVE_URL = 'https://bottomlineventuresinc-hue.github.io/tf-demo-ar-sanbernardino/';
  var LS_CHANGES = 'tf_ar_change_log_v1';
  var LS_PURCHASED = 'tf_ar_purchased_v1';
      ...
      apply: function () {
        if (heroLede) {
          heroLede.textContent =
            'Residential and commercial electrical, panel work, and wiring across San Bernardino and the Inland Empire. You get a fixed itemised quote before we start, Antonio as your named lead on site, and a twelve-month workmanship guarantee when we leave.';
        }
      }
    },
    {
  ...
  function setBarMode(mode) {
    ...
    if (!barSub) return;
    if (mode === 'updated') {
      barSub.textContent = 'Draft for Antonio at AR Electrical. Claim it, preview the rest of the journey, or request a change.';
    } else {
      barSub.textContent = 'Draft for Antonio at AR Electrical. Claim it, preview the rest of the journey, or request a change.';
    }
  }
  ...
  if (changeForm) {
    changeForm.addEventListener('submit', function (e) {
      ...
      runSpinner(
        ...
        'Updating the draft for AR Electrical. Hang tight.',
        delay,
        function () {
